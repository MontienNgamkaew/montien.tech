...
try {
    ...
    if ($deptCount == 0) {
        ...
        $db->exec("INSERT INTO jobs (department_id, name) VALUES
            (1, 'งานบริหารงานทั่วไป'), (1, 'งานบริหารและพัฒนาทรัพยากรบุคคล'), (1, 'งานการเงิน'), (1, 'งานการบัญชี'), (1, 'งานพัสดุ'), (1, 'งานทะเบียน'), (1, 'งานอาคารสถานที่'),
            ...
            (3, 'งานกิจกรรมนักเรียนนักศึกษา'), (3, 'งานครูที่ปรึกษาและการแนะแนว'), (3, 'งานปกครองและความปลอดภัยนักเรียนนักศึกษา'), (3, 'งานโครงการพิเศษและการบริการชุมชน'), (3, 'งานสวัสดิการนักเรียน นักศึกษา'),
